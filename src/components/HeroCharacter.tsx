      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="w-48 h-48 rounded-3xl border-4 border-[#e2b091] bg-black relative overflow-hidden shadow-[0_0_50px_rgba(226,176,145,0.3)]">
          <div className="absolute inset-0 flex items-center justify-center">
             <Clock className="w-32 h-32 text-primary opacity-80 animate-pulse" />
             {/* Inner Gears Simulation */}
             <div className="absolute inset-0 border-2 border-primary/20 rounded-full scale-75 animate-[spin_10s_linear_infinite]" />
             <div className="absolute inset-0 border-2 border-primary/10 rounded-full scale-50 animate-[spin_15s_linear_infinite_reverse]" />
          </div>
        </div>
